...
public class ImageFinderTest {
    ...
    public void test() throws IOException, ServletException {
        ...
        //Response is received as JSON String. Due to multithreading the order of the images won't be the same.
        // Thus the JSON string needs to be converted to list for comparison
        ...
        List<String> expected = Arrays.asList("https://picsum.photos/id/1/200/300", "https://picsum.photos/id/10/200/300", "https://picsum.photos/id/13/200/300", "https://picsum.photos/id/16/200/300", "https://picsum.photos/id/26/200/300", "https://picsum.photos/id/28/200/300", "https://picsum.photos/assets/images/favicon/favicon-32x32.png");
